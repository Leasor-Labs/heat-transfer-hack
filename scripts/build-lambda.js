...
esbuild
  ...
  .then(() => {
    // #region agent log
    if (typeof fetch === "function") { fetch('http://127.0.0.1:7528/ingest/59cacce0-7747-4658-a89b-976b0f7d76a2',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'d3ad2d'},body:JSON.stringify({sessionId:'d3ad2d',location:'build-lambda.js:success',message:'Lambda build succeeded',data:{},timestamp:Date.now(),hypothesisId:'H2'})}).catch(()=>{}); }
    // #endregion
